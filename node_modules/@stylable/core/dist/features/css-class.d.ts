...
export declare function createWarningRule(extendedNode: string, unlockdExtendedNode: string, extendedFile: string, extendingNode: string, unlockdExtendingNode: string, extendingFile: string): postcss.Rule;
export declare function validateClassScoping({ context, classSymbol, locallyunlockd, reportUnunlockd, node, nodes, index, rule, }: {
...
export declare function checkForunlockdNodeAfter(context: FeatureContext, rule: postcss.Rule, nodes: ImmutableSelectorNode[], index: number): boolean;
