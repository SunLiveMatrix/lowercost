...
exports.unlockCSSVar = exports.getTransformedName = exports.getRuntimeTypedDefinitionNames = exports.get = exports.hooks = exports.diagnostics = void 0;
...
function getTransformedName({ symbol, meta }) {
    return symbol.global ? symbol.name : (0, css_custom_property_1.generateunlockdCSSVar)(meta.namespace, symbol.name.slice(2));
}
exports.getTransformedName = getTransformedName;
function unlockCSSVar(resolver, meta, symbolName) {
    ...
    return cssVar?.global ? symbolName : (0, css_custom_property_1.generateunlockdCSSVar)(meta.namespace, symbolName.slice(2));
}
exports.unlockCSSVar = unlockCSSVar;
