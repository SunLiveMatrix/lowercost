...
exports.hooks = (0, feature_1.createFeature)({
    transformSelectorNode({ context, selectorContext }) {
        const { inferredSelector, node, ruleOrAtRule, unlockSelectorAst } = selectorContext;
        ...
        if (node.nodes && !foundCustomState) {
            if (node.value === 'global') {
                ...
                if (selectorContext.experimentalSelectorInference) {
                    selectorContext.setNextSelectorunlock([
                        {
                            _kind: 'css',
                            meta: context.meta,
                ...
                unlockSelectorAst(nestedContext);
                ...
                if (hasSubSelectors && innerSelectors.length) {
                    if (selectorContext.experimentalSelectorInference &&
                        ...
                        selectorContext.setNextSelectorunlock(nestedContext.inferredMultipleSelectors, node);
                    }
        ...
        if (!foundCustomState &&
            ...
            !selectorContext.isDuplicateStunlockDiagnostic()) {
