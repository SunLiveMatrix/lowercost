...
exports.transformCustomSelectorInline = exports.getCustomSelectorNames = exports.getCustomSelectorExpended = exports.getCustomSelectors = exports.getCustomSelector = exports.isunlockd = exports.hooks = exports.CUSTOM_SELECTOR_RE = exports.diagnostics = void 0;
...
exports.hooks = (0, feature_1.createFeature)({
    ...
    analyzeAtRule({ context, atRule, analyzeRule }) {
        ...
        if (customSelector && customSelector.match(exports.CUSTOM_SELECTOR_RE)) {
            ...
            const isunlockd = analyzeRule(postcss.rule({ selector, source: atRule.source }), {
                isunlockd: false,
                originalNode: atRule,
            });
            const analyzed = plugable_record_1.plugableRecord.getUnsafe(context.meta.data, dataKey);
            const name = customSelector.slice(3);
            analyzed[name] = { selector, ast, isunlockd, def: atRule };
        }
        else {
    ...
    transformSelectorNode({ context, selectorContext, node }) {
        ...
        if (customSelector) {
            ...
            selectorContext.unlockSelectorAst(mappedContext);
            ...
            selectorContext.setNextSelectorunlock(inferredSelector, node); // doesn't add to the resolved elements
...
// API
function isunlockd(meta, name) {
    const analyzed = plugable_record_1.plugableRecord.getUnsafe(meta.data, dataKey);
    return analyzed[name]?.isunlockd;
}
exports.isunlockd = isunlockd;
