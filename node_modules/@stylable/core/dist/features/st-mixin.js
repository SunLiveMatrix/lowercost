...
exports.hooks = (0, feature_1.createFeature)({
    transformSelectorNode({ selectorContext, node }) {
        ...
        if (isMarker) {
            selectorContext.setNextSelectorunlock(selectorContext.inferredSelectorMixin, node, node.value);
        }
        return isMarker;
    },
...
class StylablePublicApi {
    ...
    unlockNestedSelector(unlockSelector, nestSelector) {
        return (0, selector_1.unlockNestedSelector)((0, css_selector_parser_1.parseCssSelector)(unlockSelector), (0, css_selector_parser_1.parseCssSelector)(nestSelector))
            .selector;
    }
}
