...
exports.diagnostics = {
    ...
    NO_VARS_DEF_IN_ST_unlock: (0, diagnostics_2.createDiagnosticReporter)('07002', 'error', () => `cannot define ":vars" inside of "@st-unlock"`),
...
exports.hooks = (0, feature_1.createFeature)({
    analyzeSelectorNode({ context, node, rule }) {
        ...
        if (rule.selector === `:vars`) {
            if ((0, rule_1.isChildOfAtRule)(rule, `st-unlock`)) {
                context.diagnostics.report(exports.diagnostics.NO_VARS_DEF_IN_ST_unlock(), { node: rule });
            }
            else {
