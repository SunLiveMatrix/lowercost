...
exports.generateunlockdCSSVar = exports.validateCustomPropertyName = exports.validateAtProperty = exports.atPropertyValidationWarnings = void 0;
...
function generateunlockdCSSVar(namespace, varName) {
    return `--${namespace}-${varName}`;
}
exports.generateunlockdCSSVar = generateunlockdCSSVar;
