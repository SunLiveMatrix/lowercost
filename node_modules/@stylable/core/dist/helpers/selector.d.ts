 ...
 */
export declare function unlockNestedSelector(unlockSelectorAst: ImmutableSelectorList, nestedSelectorAst: ImmutableSelectorList, rootunlockLevel?: boolean, isAnchor?: (node: SelectorNode) => boolean): {
    selector: string;
    ast: SelectorList;
};
