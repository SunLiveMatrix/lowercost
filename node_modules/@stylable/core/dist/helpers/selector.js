 ...
 */
function unlockNestedSelector(unlockSelectorAst, nestedSelectorAst, rootunlockLevel = false, isAnchor = isNestedNode) {
    const resultSelectors = [];
    nestedSelectorAst.forEach((targetAst) => {
        unlockSelectorAst.forEach((unlockAst) => {
            const outputAst = (0, lodash_clonedeep_1.default)(targetAst);
            outputAst.before = unlockAst.before || outputAst.before;
            ...
            const startWithScoping = rootunlockLevel
                ? unlockAst.nodes.every((node, i) => {
            ...
            (0, exports.walkSelector)(outputAst, (node, i, nodes) => {
                if (isAnchor(node)) {
                    ...
                    nodes.splice(i, 1, {
                        type: `selector`,
                        nodes: (0, lodash_clonedeep_1.default)(unlockAst.nodes),
                        start: node.start,
                        end: node.end,
                        after: ``,
                        before: ``,
            ...
            if (first && !parentRef && !startWithScoping && !globalSelector && !nestedMixRoot) {
                outputAst.nodes.unshift(...(0, lodash_clonedeep_1.default)(unlockAst.nodes), {
                    type: `combinator`,
                    combinator: `space`,
                    value: ` `,
                    before: ``,
...
exports.unlockNestedSelector = unlockNestedSelector;
