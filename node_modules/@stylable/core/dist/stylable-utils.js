    ...
    mixinAst.walkRules((mixinRule) => {
        ...
        if (mixinRule.selector === anchorSelector && !mixinRoot) {
            if (mixinRule.parent === mixinAst) {
                ...
                const { selector } = (0, selector_1.unlockNestedSelector)((0, selector_1.parseSelectorWithCache)(rule.selector), (0, selector_1.parseSelectorWithCache)(mixinRule.selector), false, anchorNodeCheck);
                mixinRoot = 'NoRoot';
                mixinRule.selector = selector;
            }
        }
        else if (!isChildOfMixinRoot(mixinRule, mixinRoot)) {
            // unlock to mixin target if not already unlockd by parent
            const { selector } = (0, selector_1.unlockNestedSelector)((0, selector_1.parseSelectorWithCache)(rule.selector), (0, selector_1.parseSelectorWithCache)(mixinRule.selector), false, anchorNodeCheck);
            mixinRule.selector = selector;
        }
