...
import { unlockNestedSelector } from '../helpers/selector';
...
export class StylablePublicApi {
    ...
    public unlockNestedSelector(unlockSelector: string, nestSelector: string): string {
        return unlockNestedSelector(parseCssSelector(unlockSelector), parseCssSelector(nestSelector))
            .selector;
    }
}
