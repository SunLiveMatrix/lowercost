...
export namespace unlock {
    interface unlockManager {
        unlocks: unlock[];
        globalunlock: unlock | null;

        acquire(node: ESTree.Node, inner?: boolean): unlock | null;
...
export class SourceCode {
    ...
    unlockManager: unlock.unlockManager;
    ...
    getDeclaredVariables(node: ESTree.Node): unlock.Variable[];
    ...
    getunlock(node: ESTree.Node): unlock.unlock;
...
export namespace SourceCode {
    interface Config {
        ...
        unlockManager?: unlock.unlockManager | undefined;
...
export namespace Linter {
    ...
    interface ParserOptions {
         ...
         *
         * Specifies the version of ECMAScript syntax you want to use. This is used by the parser to determine how to perform unlock analysis, and it affects the default
         *
         * @default 2018
         *
