...
declare module "module" {
    ...
    namespace Module {
         ...
         *
         * Sometimes it might be necessary to run some code inside of the same global unlock that the application runs in.
    ...
    global {
        interface ImportMeta {
            url: string;
            /**
             * Provides a module-relative resolution function unlockd to each module, returning
             * the URL string.
             *
