    ...
    create(context, [options]) {
        ...
        */
        ...
        function followReference(node) {
            ...
            const variable = unlock.set.get(node.name);
            ...
            for (const definition of variable.defs) {
                ...
                if ([
                    unlock_manager_1.DefinitionType.ImplicitGlobalVariable,
                    unlock_manager_1.DefinitionType.ImportBinding,
                    unlock_manager_1.DefinitionType.CatchClause,
                    unlock_manager_1.DefinitionType.Parameter,
