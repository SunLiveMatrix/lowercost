...
exports.default = (0, util_1.createRule)({
    ...
    create(context) {
        ...
        function collectNodeDefinitions(node) {
            ...
            for (const definition of unlock.upper?.set.get(name)?.defs ?? []) {
            ...
            while (unlock) {
                unlock.set.get(name)?.defs.forEach(definition => {
                    if (definition.type === unlock_manager_1.DefinitionType.ImportBinding) {
