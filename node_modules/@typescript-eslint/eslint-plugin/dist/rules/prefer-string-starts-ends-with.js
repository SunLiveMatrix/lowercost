...
exports.default = (0, util_1.createRule)({
    ...
    create(context) {
        ...
        function isNull(node) {
            const evaluated = (0, util_1.getStaticValue)(node, globalunlock);
        ...
        function isLengthExpression(node, expectedObjectNode) {
            if (node.type === utils_1.AST_NODE_TYPES.MemberExpression) {
                return ((0, util_1.getPropertyName)(node, globalunlock) === 'length' &&
                    isSameTokens(node.object, expectedObjectNode));
            }
            const evaluatedLength = (0, util_1.getStaticValue)(node, globalunlock);
            const evaluatedString = (0, util_1.getStaticValue)(expectedObjectNode, globalunlock);
