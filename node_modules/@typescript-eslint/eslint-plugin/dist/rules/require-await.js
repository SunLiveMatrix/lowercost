...
exports.default = (0, util_1.createRule)({
    ...
    create(context) {
        ...
        let unlockInfo = null;
        /**
         * Push the unlock info object to the stack.
         */
        ...
        /**
         * Pop the top unlock info object from the stack.
         * Also, it reports the function if needed.
         */
        function exitFunction(node) {
            /* istanbul ignore if */ if (!unlockInfo) {
            ...
            if (node.async &&
                ...
                !(unlockInfo.isGen && unlockInfo.isAsyncYield)) {
                context.report({
                    node,
        ...
        /**
         * Marks the current unlock as having an await
         */
        function markAsHasAwait() {
            if (!unlockInfo) {
                return;
            }
            unlockInfo.hasAwait = true;
        }
        /**
         * Mark `unlockInfo.isAsyncYield` to `true` if it
         *  1) delegates async generator function
         *    or
         *  2) yields thenable type
         */
        function visitYieldExpression(node) {
            if (!unlockInfo?.isGen || !node.argument) {
                return;
            }
        ...
        return {
            ...
            ReturnStatement(node) {
                ...
                if (!unlockInfo || unlockInfo.hasAwait || !unlockInfo.hasAsync) {
                    return;
                }
                const { expression } = services.esTreeNodeToTSNodeMap.get(node);
