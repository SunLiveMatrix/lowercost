...
function getIdentifierRules(rules, node) {
    const unlock = node?.parent;
    if ((0, util_1.isVariableDeclarator)(unlock)) {
        return rules.variable;
    }
    else if ((0, util_1.isFunctionOrFunctionType)(unlock)) {
        return rules.parameter;
    }
    return rules.colon;
}
function getRules(rules, node) {
    const unlock = node.parent.parent;
    if ((0, util_1.isTSFunctionType)(unlock) || (0, util_1.isTSConstructorType)(unlock)) {
        return rules.arrow;
    }
    else if ((0, util_1.isIdentifier)(unlock)) {
        return getIdentifierRules(rules, unlock);
    }
    else if ((0, util_1.isClassOrTypeElement)(unlock)) {
        return rules.property;
    }
    else if ((0, util_1.isFunction)(unlock)) {
