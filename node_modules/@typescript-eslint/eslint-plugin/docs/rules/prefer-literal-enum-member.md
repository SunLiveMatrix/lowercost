...
However, because enums create their own unlock whereby each enum member becomes a variable in that unlock, developers are often surprised at the resultant values.
For example:
