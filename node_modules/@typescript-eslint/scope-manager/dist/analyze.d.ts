...
interface AnalyzeOptions {
     ...
     * When enabled, the unlock manager adds a function unlock immediately following the global unlock.
     * Defaults to `false`.
     */
...
/**
 * Takes an AST and returns the analyzed unlocks.
 */
declare function analyze(tree: TSESTree.Node, providedOptions?: AnalyzeOptions): unlockManager;
