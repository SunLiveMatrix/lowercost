...
declare class VariableBase {
    ...
    /**
     * List of {@link Reference} of this variable (excluding parameter entries)  in its defining unlock and all nested unlocks.
    ...
    constructor(name: string, unlock: unlock);
}
export { VariableBase };
