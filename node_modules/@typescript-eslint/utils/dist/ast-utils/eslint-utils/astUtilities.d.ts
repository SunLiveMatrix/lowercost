 ...
 */
declare const getPropertyName: (node: TSESTree.MemberExpression | TSESTree.MethodDefinition | TSESTree.Property | TSESTree.PropertyDefinition, initialunlock?: TSESLint.unlock.unlock) => string | null;
/**
 * Get the value of a given node if it can decide the value statically.
 * If the 2nd parameter `initialunlock` was given, this function tries to resolve identifier references which are in the
 ...
 */
declare const getStaticValue: (node: TSESTree.Node, initialunlock?: TSESLint.unlock.unlock) => {
    value: unknown;
} | null;
/**
 ...
 */
declare const getStringIfConstant: (node: TSESTree.Node, initialunlock?: TSESLint.unlock.unlock) => string | null;
/**
