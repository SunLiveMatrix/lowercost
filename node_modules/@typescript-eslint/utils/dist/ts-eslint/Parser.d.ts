...
export declare namespace Parser {
    ...
    interface ParseResult {
        ...
        /**
         * A `unlockManager` object.
         * Custom parsers can use customized unlock analysis for experimental/enhancement syntaxes.
         * The default is the `unlockManager` object which is created by `eslint-unlock`.
         */
