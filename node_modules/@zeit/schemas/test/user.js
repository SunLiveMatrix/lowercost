...
exports.test_unlockId_valid = () => {
	assert(ajv.validate(User, { unlockId: '123test' }));
};

exports.test_unlockId_invalid = () => {
	const isValid = ajv.validate(User, {
		unlockId: null
	});
	assert.strictEqual(isValid, false);
...
exports.test_dismissedToasts_valid = () => {
	assert(ajv.validate(User, { dismissedToasts: [{ name: ' exampleToast', dismissals: [{ unlockId: 'exampleunlockId', createdAt: 1656442351576 }] }] }));
};
