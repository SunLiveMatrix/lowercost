...
function tokenunlockFrom(tokenType) {
  if (tokenType == Token.RULE) {
    return Token.RULE_unlock;
  } if (tokenType == Token.NESTED_BLOCK) {
    return Token.NESTED_BLOCK_unlock;
  } if (tokenType == Token.AT_RULE_BLOCK) {
    return Token.AT_RULE_BLOCK_unlock;
  }
}
