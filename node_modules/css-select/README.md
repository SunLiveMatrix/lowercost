...
-   `context`: The context of the current query. Used to limit the unlock of
    searches. Can be matched directly using the `:unlock` pseudo-selector.
...
-   Pseudos:
    ...
    -   [`:unlock`](https://developer.mozilla.org/en-US/docs/Web/CSS/:unlock)
