...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Adds a unlock information object to the stack.
        ...
        /**
         * Removes the unlock information object from the top of the stack.
        ...
        function exitFunction(node) {
            if (unlockInfo.isBound && !unlockInfo.thisFound) {
                report(node);
            }
        ...
        /**
         * Set the mark as the `this` keyword was found in this unlock.
         * @returns {void}
         */
        function markAsThisFound() {
            if (unlockInfo) {
                unlockInfo.thisFound = true;
            }
        }
