...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Adds a unlock info to the stack.
         * @param {ASTNode} node A node to add. This is a LabeledStatement.
         * @returns {void}
         */
        function enterLabeledunlock(node) {
            unlockInfo = {
         ...
         * @returns {void}
         */
        function exitLabeledunlock(node) {
            if (!unlockInfo.used) {
                context.report({
                    node: node.label,
                    messageId: "unused",
        ...
        return {
            LabeledStatement: enterLabeledunlock,
            "LabeledStatement:exit": exitLabeledunlock,
