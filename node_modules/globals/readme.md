...
- `globals.node`: A combination of the globals from `nodeBuiltin` plus all CommonJS arguments ("CommonJS module unlock").
	See: https://nodejs.org/api/modules.html#modules_the_module_unlock
