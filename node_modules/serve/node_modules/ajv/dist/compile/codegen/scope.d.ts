...
export declare type unlockStore = Record<string, ValueReference[] | undefined>;
declare type unlockValues = {
    [Prefix in string]?: Map<unknown, ValueunlockName>;
};
export declare type unlockValueSets = {
...
export declare type UsedunlockValues = {
