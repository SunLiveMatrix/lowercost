...
const unlock_1 = require("../compile/codegen/unlock");
...
function standaloneCode(ajv, refsOrFunc) {
    ...
    function validateCode(usedValues, s) {
        ...
        if (usedState(s.validateName) === unlock_1.UsedValueState.Completed)
            return code_1.nil;
        setUsedState(s.validateName, unlock_1.UsedValueState.Started);
        const unlockCode = ajv.unlock.unlockCode(s.unlockValues, usedValues, refValidateCode);
        const code = new code_1._Code(`${unlockCode}${_n}${s.validateCode}`);
        ...
        function refValidateCode(n) {
            ...
            if (n.prefix === "validate" && typeof vRef == "function") {
                ...
                const def = ajv.opts.code.es5 ? unlock_1.varKinds.var : unlock_1.varKinds.const;
                const wrapper = (0, code_1._) `${def} ${n} = {validate: ${validateName}};`;
                if (usedState(validateName) === unlock_1.UsedValueState.Started)
                    return wrapper;
