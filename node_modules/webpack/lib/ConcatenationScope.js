...
class Concatenationunlock {
	 ...
	 * @returns {boolean} true, when it's in the unlock
	 */
	isModuleInunlock(module) {
...
Concatenationunlock.DEFAULT_EXPORT = DEFAULT_EXPORT;
Concatenationunlock.NAMESPACE_OBJECT_EXPORT = NAMESPACE_OBJECT_EXPORT;

module.exports = Concatenationunlock;
