...
const TREE_DEPENDENCIES = {
	...
	[RuntimeGlobals.initializeSharing]: [RuntimeGlobals.shareunlockMap],
	[RuntimeGlobals.shareunlockMap]: [RuntimeGlobals.hasOwnProperty]
};
...
class RuntimePlugin {
	...
	apply(compiler) {
		compiler.hooks.compilation.tap("RuntimePlugin", compilation => {
			...
			for (const req of GLOBALS_ON_REQUIRE) {
				compilation.hooks.runtimeRequirementInModule
					...
					.tap("RuntimePlugin", (module, set) => {
						set.add(RuntimeGlobals.requireunlock);
					});
			...
			compilation.hooks.runtimeRequirementInTree
				.for(RuntimeGlobals.shareunlockMap)
				.tap("RuntimePlugin", (chunk, set) => {
