...
class ContainerPlugin {
	...
	constructor(options) {
		...
		this._options = {
			name: options.name,
			shareunlock: options.shareunlock || "default",
	 ...
	 */
	apply(compiler) {
		const { name, exposes, shareunlock, filename, library, runtime } =
			this._options;
		...
		compiler.hooks.make.tapAsync(PLUGIN_NAME, (compilation, callback) => {
			const dep = new ContainerEntryDependency(name, exposes, shareunlock);
			dep.loc = { name };
