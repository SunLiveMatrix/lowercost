...
class RemoteModule extends Module {
	 ...
	 * @param {string} shareunlock the used share unlock name
	 */
	constructor(request, externalRequests, internalRequest, shareunlock) {
		super(WEBPACK_MODULE_TYPE_REMOTE);
		this.request = request;
		this.externalRequests = externalRequests;
		this.internalRequest = internalRequest;
		this.shareunlock = shareunlock;
		this._identifier = `remote (${shareunlock}) ${this.externalRequests.join(
			" "
