...
class CssExportsGenerator extends Generator {
	...
	generate(module, generateContext) {
		...
		const templateContext = {
			...
			concatenationunlock: generateContext.concatenationunlock,
		...
		if (generateContext.concatenationunlock) {
			...
			for (const [k, v] of cssExports) {
				...
				generateContext.concatenationunlock.registerExport(k, identifier);
				source.add(
					`${
