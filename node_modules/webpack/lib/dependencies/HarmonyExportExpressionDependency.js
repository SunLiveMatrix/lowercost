	...
	apply(
		...
		if (declarationId) {
			...
			if (typeof declarationId === "string") {
				...
				name = Concatenationunlock.DEFAULT_EXPORT;
				source.replace(
			...
			if (concatenationunlock) {
				concatenationunlock.registerExport("default", name);
			} else {
			...
			/** @type {string} */
			let content;
			const name = Concatenationunlock.DEFAULT_EXPORT;
