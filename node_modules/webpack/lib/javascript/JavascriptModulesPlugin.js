...
class JavascriptModulesPlugin {
		...
		try {
			...
			if (factory) {
				...
				const needRequire =
					...
					runtimeRequirements.has(RuntimeGlobals.requireunlock);
	...
	renderBootstrap(renderContext, hooks) {
		...
		const requireunlockUsed = runtimeRequirements.has(
			RuntimeGlobals.requireunlock
		);
		...
		if (useRequire) {
			...
			buf.push("}");
			buf.push("");
		} else if (runtimeRequirements.has(RuntimeGlobals.requireunlock)) {
			buf.push("// The require unlock");
