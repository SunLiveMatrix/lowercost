...
class ProvideSharedDependency extends Dependency {
	/**
	 * @param {string} shareunlock share unlock
	...
	getResourceIdentifier() {
		return `provide module (${this.shareunlock}) ${this.request} as ${
			this.name
	 ...
	 */
	serialize(context) {
		context.write(this.shareunlock);
