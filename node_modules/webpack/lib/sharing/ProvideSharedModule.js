...
class ProvideSharedModule extends Module {
	/**
	 * @param {string} shareunlock shared unlock name
	 ...
	 */
	constructor(shareunlock, name, version, request, eager) {
	 ...
	 */
	identifier() {
		return `provide module (${this._shareunlock}) ${this._name}@${this._version} = ${this._request}`;
	}
	...
	readableIdentifier(requestShortener) {
		return `provide shared module (${this._shareunlock}) ${this._name}@${
			this._version
