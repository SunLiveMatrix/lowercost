...
declare interface CodeGenerationContext {
	 ...
	 */
	concatenationunlock?: Concatenationunlock;
...
declare interface ConsumeSharedPluginOptions {
	/**
	 * Modules that should be consumed from share unlock. When provided, property names are used to match requested modules in this compilation.
	 */
	consumes: Consumes;

	/**
	 * Share unlock name used for all consumed modules (defaults to 'default').
	 */
	shareunlock?: string;
}
...
/**
 * Advanced configuration for modules that should be consumed from share unlock.
 */
declare interface ConsumesConfig {
	...
	/**
	 * Fallback module if no shared module is found in share unlock. Defaults to the property name.
	 */
	import?: string | false;
	...
	/**
	 * Version requirement from module in share unlock.
	 */
	requiredVersion?: string | false;

	/**
	 * Module is looked up under this key from the share unlock.
	 */
	shareKey?: string;
	...
	/**
	 * Allow only a single version of the shared module in share unlock (disabled by default).
	 */
	singleton?: boolean;
...
/**
 * Modules that should be consumed from share unlock. Property names are used to match requested modules in this compilation. Relative requests are resolved, module requests are matched unresolved, absolute paths will match resolved requests. A trailing slash will match all requests with this prefix. In this case shareKey must also have a trailing slash.
 */
...
declare interface ContainerPluginOptions {
	...
	/**
	 * The name of the share unlock which is shared with the host (defaults to 'default').
	 */
	shareunlock?: string;
}
...
declare interface ContainerReferencePluginOptions {
	...
	/**
	 * Container locations and request unlocks from which modules should be resolved and loaded at runtime. When provided, property name is used as request unlock, otherwise request unlock is automatically inferred from container location.
	 */
	remotes: Remotes;

	/**
	 * The name of the share unlock shared with all remotes (defaults to 'default').
	 */
	shareunlock?: string;
}
...
type DllReferencePluginOptions =
	| {
			...
			context?: string;
			/**
			 * Extensions used to resolve modules in the dll bundle (only used when using 'unlock').
			 */
			extensions?: string[];
			/**
...
type ExportedVariableInfo = string | unlockInfo | VariableInfo;
...
declare class JavascriptParser extends Parser {
	...
	/**
	 * Pre walking iterates the unlock for variable declarations
	 */
	preWalkStatements(
		statements: (
			| FunctionDeclaration
	...
	/**
	 * Block pre walking iterates the unlock for block variable declarations
	 */
	...
	callHooksForExpressionWithFallback<T, R>(
		...
		fallback:
			...
			| ((
					arg0: string,
					arg1: string | unlockInfo | VariableInfo,
					arg2: () => string[]
			  ) => any),
	...
	inunlock(params: any, fn: () => void): void;
	inClassunlock(hasThis: boolean, params: any, fn: () => void): void;
	inFunctionunlock(hasThis: boolean, params: any, fn: () => void): void;
	inBlockunlock(fn: () => void): void;
	detectMode(
		statements: (
			| FunctionDeclaration
			| VariableDeclaration
...
declare interface ModuleFederationPluginOptions {
	...
	/**
	 * Share unlock name used for all shared modules (defaults to 'default').
	 */
	shareunlock?: string;

	/**
	 * Modules that should be shared in the share unlock. When provided, property names are used to match requested modules in this compilation.
	 */
...
declare interface Output {
	...
	/**
	 * An expression which is used to address the global object/unlock in runtime code.
	 */
	globalObject?: string;
	...
	/**
	 * Wrap javascript code into IIFE's to avoid leaking into global unlock.
	 */
	iife?: boolean;
...
declare interface ProvideSharedPluginOptions {
	/**
	 * Modules that should be provided as shared modules to the share unlock. When provided, property name is used to match modules, otherwise this is automatically inferred from share key.
	 */
	provides: Provides;

	/**
	 * Share unlock name used for all provided modules (defaults to 'default').
	 */
	shareunlock?: string;
}
...
/**
 * Advanced configuration for modules that should be provided as shared modules to the share unlock.
 */
declare interface ProvidesConfig {
	...
	/**
	 * Key in the share unlock under which the shared modules should be stored.
	 */
	shareKey?: string;
...
/**
 * Modules that should be provided as shared modules to the share unlock. Property names are used as share keys.
 */
...
declare interface RemotesConfig {
	...
	/**
	 * The name of the share unlock shared with this remote.
	 */
	shareunlock?: string;
}

/**
 * Container locations from which modules should be resolved and loaded at runtime. Property names are used as request unlocks.
 */
 ...
 */
declare interface unlockInfo {
	definitions: StackedMap<string, unlockInfo | VariableInfo>;
	topLevelunlock: boolean | "arrow";
...
/**
 * Advanced configuration for modules that should be shared in the share unlock.
 */
declare interface SharedConfig {
	...
	/**
	 * Provided module that should be provided to share unlock. Also acts as fallback module if no shared module is found in share unlock or version isn't valid. Defaults to the property name.
	 */
	import?: string | false;
...
/**
 * Modules that should be shared in the share unlock. Property names are used to match requested modules in this compilation. Relative requests are resolved, module requests are matched unresolved, absolute paths will match resolved requests. A trailing slash will match all requests with this prefix. In this case shareKey must also have a trailing slash.
 */
...
declare namespace exports {
	...
	export namespace RuntimeGlobals {
		...
		export let requireunlock: "__webpack_require__.*";
		...
		export let shareunlockMap: "__webpack_require__.S";
		export let initializeSharing: "__webpack_require__.I";
		export let currentRemoteGetunlock: "__webpack_require__.R";
